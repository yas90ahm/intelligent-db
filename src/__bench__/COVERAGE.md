...
- The costly-independent curve (#4) is reported as a **failure-mode boundary**, not a defense — ID's ASR rises monotonically to the undefended ceiling as the attacker pays. This is the core of "priced, not prevented" and should be presented as such.
